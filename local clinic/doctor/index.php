                                ...
                                <div class="row">
                                    <div class="col-md-3 my-2 bg-info mx-2" style="height:150px;">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <h5 class="tex-white my-4">My Profile</h5>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    ?>
                                                    <h5 class="tex-white my-2" style="font-size:30px;"><?php echo $pp; ?></h5>
                                                    <h5 class="tex-white">Total</h5>
                                                    <h5 class="tex-white">Patient</h5>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    ?>
                                                    <h5 class="tex-white my-2" style="font-size:30px;"><?php echo $appoint; ?></h5>
                                                    <h5 class="tex-white">Total</h5>
                                                    <h5 class="tex-white">Appointment</h5>
